...
const YourComponent = () => {
  const products = [
    ...
    { id: 4, name: 'Pets Junction', image: pets_junction, description: 'Pet variety : the diverse range of pets available such a dogs cats small animals birds reptiles and fish .The variety of pet supplies and accessories available.' },
